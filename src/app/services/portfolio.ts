...
export class PortfolioService {
  ...
  private projects: Project[] = [
    // Sorted by completion date (newest first)
    {
      ...
      description:
        'Modern, animated portfolio website with dynamic CV generator built with Angular 20.',
      longDescription:
        'A fully responsive portfolio website built with Angular 20 using standalone components, signals, and modern best practices. Features include: GSAP-powered animations with ScrollTrigger, 3D rolling text effect using SplitText, particle background, dark/light theme toggle with multiple color schemes, contact form with EmailJS integration, and smooth scroll navigation. Includes a dynamic CV generator that creates a professional PDF with all portfolio data, automatically matching the active website color scheme. The site showcases my projects, technologies, work experience, education, and certifications.',
      technologies: [
        'Angular',
        'TypeScript',
        'SCSS',
    ...
    },
    {
      ...
      description:
        'Modern, responsive website for a traditional Belgian bakery with SEO optimization.',
      longDescription:
    ...
    },
    {
      ...
      description:
        'Research on integration of native components, widgets and watch extensions with React Native.',
      longDescription:
    ...
    },
    {
      ...
      title: 'EcoInsights',
      description:
        'iOS app that helps consumers make sustainable choices through AR product recognition.',
      longDescription:
  ...
  private experiences: Experience[] = [
    ...
    },
    {
      ...
      current: false,
      description:
        'For my third term at Silverfin, I switched from Team Platform to Team UK. Within this team, I work on updating Corporate Tax templates to support multiple business types. The UK-team is based in the UK office so this was a fully remote role.',
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "This team handles all clients that do not belong to Silverfin's standard markets. I helped develop custom workflows and templates for clients like EY Portugal and MYOB Australia. Due to my previous experience, I was tasked with creating the more complex templates.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        'Silverfin (part of Visma) is the cloud-based accounting platform that top firms use for their digital transformation strategy. My primary focus was the Personal Income Tax project - a highly time-sensitive project where I was added to meet the deadline.',
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        'After my internship, I continued working on the Year In Review app. Improvements included: simpler navigation, cleaning up visuals, bugfixes, introduction of React Query for better state management, and code cleanup.',
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        'As the conclusion of the Java traineeship, we developed CarpoolTool, a web application for Axxes employees to organize carpooling to company events.',
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        'During my internship at Axxes, I worked with three other interns on a Year In Review feature. Inspired by Spotify Wrapped, it provides an overview of event attendance, project involvement, work hours analysis, and more.',
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        'During my beach period I worked on a intern Angular project where I developed a feature for the Axxes portal. This was a great opportunity to gain more experience with Angular.',
      achievements: [
  ...
  getExperiences(): Observable<Experience[]> {
    const sorted = [...this.experiences].sort(
